...
function TableToolbar(props){
  ...
  const crear = () => {
    return navigate(`/especialidad/create/`)
  }
  const update = () => {
    console.log(idSelected)
    return navigate(`/especialidad/update/${idSelected}`)
  }
  ...
  return(
    ...
    ? (
      ...
      >
        {numSelected} Especialidad Seleccionada
      </Typography>
      )
    : (
      <Typography
      ...
      >
       ...
       {numSelected > 0
        ? (<>
          <Tooltip title='Actualizar Especialidad'>
...
export default function TableEspecialidad(){
