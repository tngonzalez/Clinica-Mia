...
function TableToolbar(props){
  ...
  const update = () => {
    ...
    return navigate(`/alergia/update/${idSelected}`)
  }

  const crear = () => {
    return navigate(`/alergia/create/`)
  }
  ...
  return(
    ...
    ? (
      ...
      >
        {numSelected} Alergia Seleccionada
      </Typography>
      )
    : (
      <Typography
      ...
      >
       ...
       {numSelected > 0
        ? (<>
          ...
          <Tooltip title='Actualizar Alergia'>
...
export default function TableAlergia(){
           ...
           >
            ...
            {(data)
              ...
              {/*Aca se mencionan cada una de los celdas*/}   
                  ...
                  <StyledTableCell>{row.reaccion}</StyledTableCell>
                  <StyledTableCell>{row.observacion}</StyledTableCell>
                  <StyledTableCell>{row.tipoalergia}</StyledTableCell>
