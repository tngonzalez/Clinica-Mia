...
function TableToolbar(props){
  ...
  const crear = () => {
    return navigate(`/enfermedades/create/`)
  }
  ...
  return(
    ...
    ? (
      ...
      >
        {numSelected} Enfermedad Seleccionada
      </Typography>
      )
    : (
      <Typography
      ...
      >
        Enfermedades Registrados
      </Typography>
      )}
       {numSelected > 0
        ? (<>

          <Tooltip title='Actualizar Enfermedad'>
...
export default function TableEnfermedad(){
