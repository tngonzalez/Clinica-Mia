...
function TableToolbar(props){
  ...
  const update = () => {
    ...
    return navigate(`/expediente/update/${idSelected}`)
  }
  const crear = () => {
    return navigate(`/expediente/create/`)
  }
  const expediente = () => {
    console.log(idSelected)
    return navigate(`/expediente/${idSelected}`)
  }
  ...
  return(
    ...
    ? (
      ...
      >
        {numSelected} Expediente Seleccionado
      </Typography>
      )
    : (
      <Typography
      ...
      >
       ...
       {numSelected > 0
        ? (<>
          <Tooltip title='Mostrar Expediente'>
          <IconButton onClick={expediente}>
            <RemoveRedEyeIcon key={idSelected}/>
          </IconButton>
          </Tooltip>
          <Tooltip title='Actualizar Expediente'>
        ...
        : (
            <Tooltip title='Agregar Expediente'>
...
export default function TableExpediente(){
  ...
  const { data, error, loaded } = useCallApi({ endpoint: 'expediente' })
           ...
           >
            ...
            {(data)
              ...
              {/*Aca se mencionan cada una de los celdas*/}   
                  ...
                  <StyledTableCell>{row.fechaNac}</StyledTableCell>
