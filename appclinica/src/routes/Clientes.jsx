...
function TableToolbar(props){
  ...
  const crear = () => {
    return navigate(`/usuario/create/`)
  }
  const detalle = () => {
    console.log(idSelected)
    return navigate(`/expecli/${idSelected}`)
  }
  ...
  return(
    ...
    ? (
      ...
      >
        {numSelected} Cliente Seleccionado
      </Typography>
      )
    : (
      <Typography
...
export default function CustomizedTables(){
  ...
  const { data, error, loaded } = useCallApi({ endpoint: 'usuario/getClientes/1' })
