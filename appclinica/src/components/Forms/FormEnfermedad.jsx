...
export function FormEnfermedad(){
    ...
    const { data, error, loaded } = useCallApi({ endpoint: `enfermedades/getForm/${id}` })
    //Respuesta de la solicitud 
    const { responseData, errorData, loadedData } = useSubmitForm({ endpoint: 'enfermedades', action, formData, start })
